        ...
        <div class="bg-slate-900/60">
            <div class="py-12 mx-40 text-white">
                <div class="flex justify-center items-center space-x-10">
                    ...
                    <div>
                        <form class="bg-green-900/70 p-8 rounded-md">
                            ...
                            <p class="mb-3"><input class="rounded-md w-full p-2 text-black" type="text"
                                                   placeholder="Username"/></p>
                            <p class="mb-3"><input class="rounded-md w-full p-2 text-black" type="email"
                                                   placeholder="Email"/></p>
                            <p class="mb-3"><input class="rounded-md w-full p-2 text-black" type="password"
                                                   placeholder="Password"/></p>
                            <p class="mb-5"><input class="rounded-md w-full p-2 text-black" type="password"
                                                   placeholder="Confirm Password"/></p>
                            <button class="font-medium uppercase border-2 rounded-md p-3 w-full hover:bg-green-800">Sign
                                Up
                            </button>
                        </form>
                    </div>
